...
static const u8 sOpponentMugshotsPalIDs[TRAINER_PIC_COUNT] =
{
    [TRAINER_PIC_HIKER]                 = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_AQUA_GRUNT_M]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_POKEMON_BREEDER_F]     = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_COOLTRAINER_M]         = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_BIRD_KEEPER]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_COLLECTOR]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_AQUA_GRUNT_F]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SWIMMER_M]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_MAGMA_GRUNT_M]         = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_EXPERT_M]              = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_AQUA_ADMIN_M]          = MUGSHOT_COLOR_BLUE,
    [TRAINER_PIC_BLACK_BELT]            = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_AQUA_ADMIN_F]          = MUGSHOT_COLOR_BLUE,
    [TRAINER_PIC_AQUA_LEADER_ARCHIE]    = MUGSHOT_COLOR_BLUE,
    [TRAINER_PIC_HEX_MANIAC]            = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_AROMA_LADY]            = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_RUIN_MANIAC]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_INTERVIEWER]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_TUBER_F]               = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_TUBER_M]               = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_COOLTRAINER_F]         = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_LADY]                  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_BEAUTY]                = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_RICH_BOY]              = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_EXPERT_F]              = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_POKEMANIAC]            = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_MAGMA_GRUNT_F]         = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_GUITARIST]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_KINDLER]               = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_CAMPER]                = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PICNICKER]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_BUG_MANIAC]            = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PSYCHIC_M]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PSYCHIC_F]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_GENTLEMAN]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_ELITE_FOUR_SIDNEY]     = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_ELITE_FOUR_PHOEBE]     = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_ELITE_FOUR_GLACIA]     = MUGSHOT_COLOR_PINK,
    [TRAINER_PIC_ELITE_FOUR_DRAKE]      = MUGSHOT_COLOR_BLUE,
    [TRAINER_PIC_LEADER_ROXANNE]        = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_LEADER_BRAWLY]         = MUGSHOT_COLOR_BLUE,
    [TRAINER_PIC_LEADER_WATTSON]        = MUGSHOT_COLOR_YELLOW,
    [TRAINER_PIC_LEADER_FLANNERY]       = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_LEADER_NORMAN]         = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_LEADER_WINONA]         = MUGSHOT_COLOR_YELLOW,
    [TRAINER_PIC_LEADER_TATE_AND_LIZA]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_LEADER_JUAN]           = MUGSHOT_COLOR_BLUE,
    [TRAINER_PIC_SCHOOL_KID_M]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SCHOOL_KID_F]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SR_AND_JR]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_POKEFAN_M]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_POKEFAN_F]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_YOUNGSTER]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_CHAMPION_WALLACE]      = MUGSHOT_COLOR_YELLOW,
    [TRAINER_PIC_FISHERMAN]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_CYCLING_TRIATHLETE_M]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_CYCLING_TRIATHLETE_F]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_RUNNING_TRIATHLETE_M]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_RUNNING_TRIATHLETE_F]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SWIMMING_TRIATHLETE_M] = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SWIMMING_TRIATHLETE_F] = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_DRAGON_TAMER]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_NINJA_BOY]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_BATTLE_GIRL]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PARASOL_LADY]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SWIMMER_F]             = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_TWINS]                 = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_MAGMA_ADMIN]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SAILOR]                = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_WALLY]                 = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_BRENDAN]               = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_MAY]                   = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_POKEMON_BREEDER_M]     = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_BUG_CATCHER]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_POKEMON_RANGER_M]      = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_POKEMON_RANGER_F]      = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_MAGMA_LEADER_MAXIE]    = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_LASS]                  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_YOUNG_COUPLE]          = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_OLD_COUPLE]            = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_SIS_AND_BRO]           = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_STEVEN]                = MUGSHOT_COLOR_GREEN,
    [TRAINER_PIC_SALON_MAIDEN_ANABEL]   = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_DOME_ACE_TUCKER]       = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PALACE_MAVEN_SPENSER]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_ARENA_TYCOON_GRETA]    = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_FACTORY_HEAD_NOLAND]   = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PIKE_QUEEN_LUCY]       = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_PYRAMID_KING_BRANDON]  = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_RED]                   = MUGSHOT_COLOR_PURPLE,
    [TRAINER_PIC_LEAF]                  = MUGSHOT_COLOR_PURPLE,
