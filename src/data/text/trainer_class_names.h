const u8 gTrainerClassNames[][16] = {
	...
	[TRAINER_CLASS_ROUTE_BOSS] = _("Boss Trainer"),
	[TRAINER_CLASS_FINAL_BOSS] = _("Ex Magma Admin"),
    ...
    [TRAINER_CLASS_JOHTO_LEADER] = _("{PKMN} Trainer"),
    [TRAINER_CLASS_JOHTO_CHAMPION] = _("{PKMN} Trainer"),
};
