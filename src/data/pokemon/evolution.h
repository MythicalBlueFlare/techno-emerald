const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_LEVEL, 40, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK_ALOLAN}},
    [SPECIES_LICKITUNG]             = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 36, SPECIES_WEEZING_GALARIAN}},
    ...
    [SPECIES_SERVINE]               = {{EVO_LEVEL, 34, SPECIES_SERPERIOR}},
    [SPECIES_TEPIG]                 = {{EVO_LEVEL, 16, SPECIES_PIGNITE}},
    [SPECIES_PIGNITE]               = {{EVO_LEVEL, 34, SPECIES_EMBOAR}},
    [SPECIES_OSHAWOTT]              = {{EVO_LEVEL, 16, SPECIES_DEWOTT}},
    [SPECIES_DEWOTT]                = {{EVO_LEVEL, 34, SPECIES_SAMUROTT}},
    [SPECIES_PATRAT]                = {{EVO_LEVEL, 18, SPECIES_WATCHOG}},
    [SPECIES_LILLIPUP]              = {{EVO_LEVEL, 16, SPECIES_HERDIER}},
    [SPECIES_HERDIER]               = {{EVO_LEVEL, 30, SPECIES_STOUTLAND}},
    [SPECIES_PURRLOIN]              = {{EVO_LEVEL, 23, SPECIES_LIEPARD}},
    ...
    [SPECIES_ROGGENROLA]            = {{EVO_LEVEL, 21, SPECIES_BOLDORE}},
    [SPECIES_BOLDORE]               = {{EVO_LEVEL, 38, SPECIES_GIGALITH}},
    [SPECIES_WOOBAT]                = {{EVO_LEVEL, 25, SPECIES_SWOOBAT}},
    [SPECIES_DRILBUR]               = {{EVO_LEVEL, 31, SPECIES_EXCADRILL}},
    [SPECIES_AUDINO]                = {{EVO_MEGA_EVOLUTION, ITEM_AUDINITE, SPECIES_AUDINO_MEGA}},
    [SPECIES_TIMBURR]               = {{EVO_LEVEL, 21, SPECIES_GURDURR}},
    [SPECIES_GURDURR]               = {{EVO_LEVEL, 38, SPECIES_CONKELDURR}},
    [SPECIES_TYMPOLE]               = {{EVO_LEVEL, 18, SPECIES_PALPITOAD}},
    [SPECIES_PALPITOAD]             = {{EVO_LEVEL, 35, SPECIES_SEISMITOAD}},
    [SPECIES_SEWADDLE]              = {{EVO_LEVEL, 12, SPECIES_SWADLOON}},
    [SPECIES_SWADLOON]              = {{EVO_LEVEL, 27, SPECIES_LEAVANNY}},
    [SPECIES_VENIPEDE]              = {{EVO_LEVEL, 12, SPECIES_WHIRLIPEDE}},
    [SPECIES_WHIRLIPEDE]            = {{EVO_LEVEL, 27, SPECIES_SCOLIPEDE}},
    ...
    [SPECIES_TIRTOUGA]              = {{EVO_LEVEL, 40, SPECIES_CARRACOSTA}},
    [SPECIES_ARCHEN]                = {{EVO_LEVEL, 40, SPECIES_ARCHEOPS}},
    ...
    [SPECIES_GOTHITA]               = {{EVO_LEVEL, 16, SPECIES_GOTHORITA}},
    [SPECIES_GOTHORITA]             = {{EVO_LEVEL, 34, SPECIES_GOTHITELLE}},
    [SPECIES_SOLOSIS]               = {{EVO_LEVEL, 16, SPECIES_DUOSION}},
    [SPECIES_DUOSION]               = {{EVO_LEVEL, 34, SPECIES_REUNICLUS}},
    [SPECIES_DUCKLETT]              = {{EVO_LEVEL, 26, SPECIES_SWANNA}},
    [SPECIES_VANILLITE]             = {{EVO_LEVEL, 25, SPECIES_VANILLISH}},
    [SPECIES_VANILLISH]             = {{EVO_LEVEL, 42, SPECIES_VANILLUXE}},
    [SPECIES_DEERLING]              = {{EVO_LEVEL, 27, SPECIES_SAWSBUCK}},
    [SPECIES_KARRABLAST]            = {{EVO_LEVEL, 40, SPECIES_ESCAVALIER}},
    [SPECIES_FOONGUS]               = {{EVO_LEVEL, 34, SPECIES_AMOONGUSS}},
    [SPECIES_FRILLISH]              = {{EVO_LEVEL, 34, SPECIES_JELLICENT}},
    [SPECIES_JOLTIK]                = {{EVO_LEVEL, 30, SPECIES_GALVANTULA}},
    [SPECIES_FERROSEED]             = {{EVO_LEVEL, 38, SPECIES_FERROTHORN}},
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 21, SPECIES_KLANG}},
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 40, SPECIES_KLINKLANG}},
    [SPECIES_TYNAMO]                = {{EVO_LEVEL, 27, SPECIES_EELEKTRIK}},
    [SPECIES_EELEKTRIK]             = {{EVO_LEVEL, 38, SPECIES_EELEKTROSS}},
    [SPECIES_ELGYEM]                = {{EVO_LEVEL, 38, SPECIES_BEHEEYEM}},
    [SPECIES_LITWICK]               = {{EVO_LEVEL, 38, SPECIES_LAMPENT}},
    [SPECIES_LAMPENT]               = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_CHANDELURE}},
    [SPECIES_AXEW]                  = {{EVO_LEVEL, 35, SPECIES_FRAXURE}},
    [SPECIES_FRAXURE]               = {{EVO_LEVEL, 47, SPECIES_HAXORUS}},
    [SPECIES_CUBCHOO]               = {{EVO_LEVEL, 37, SPECIES_BEARTIC}},
    [SPECIES_SHELMET]               = {{EVO_LEVEL, 40, SPECIES_ACCELGOR}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 38, SPECIES_BRAVIARY}},
    [SPECIES_VULLABY]               = {{EVO_LEVEL, 38, SPECIES_MANDIBUZZ}},
    [SPECIES_DEINO]                 = {{EVO_LEVEL, 35, SPECIES_ZWEILOUS}},
    [SPECIES_ZWEILOUS]              = {{EVO_LEVEL, 52, SPECIES_HYDREIGON}},
    [SPECIES_LARVESTA]              = {{EVO_LEVEL, 50, SPECIES_VOLCARONA}},
    [SPECIES_CHESPIN]               = {{EVO_LEVEL, 16, SPECIES_QUILLADIN}},
    [SPECIES_QUILLADIN]             = {{EVO_LEVEL, 34, SPECIES_CHESNAUGHT}},
    [SPECIES_FENNEKIN]              = {{EVO_LEVEL, 16, SPECIES_BRAIXEN}},
    [SPECIES_BRAIXEN]               = {{EVO_LEVEL, 34, SPECIES_DELPHOX}},
    ...
    [SPECIES_FLETCHINDER]           = {{EVO_LEVEL, 32, SPECIES_TALONFLAME}},
    ...
    [SPECIES_HONEDGE]               = {{EVO_LEVEL, 40, SPECIES_DOUBLADE}},
    [SPECIES_DOUBLADE]              = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_AEGISLASH}},
    [SPECIES_SPRITZEE]              = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SLURPUFF}},
    [SPECIES_INKAY]                 = {{EVO_LEVEL, 23, SPECIES_MALAMAR}},
    [SPECIES_BINACLE]               = {{EVO_LEVEL, 30, SPECIES_BARBARACLE}},
    [SPECIES_SKRELP]                = {{EVO_LEVEL, 35, SPECIES_DRAGALGE}},
    [SPECIES_CLAUNCHER]             = {{EVO_LEVEL, 32, SPECIES_CLAWITZER}},
	...
	[SPECIES_CARBINK]               = {{EVO_LEVEL, 50, SPECIES_DIANCIE}},
    ...
    [SPECIES_YUNGOOS]               = {{EVO_LEVEL, 18, SPECIES_GUMSHOOS}},
    [SPECIES_GRUBBIN]               = {{EVO_LEVEL, 12, SPECIES_CHARJABUG}},
    ...
    [SPECIES_MAREANIE]              = {{EVO_LEVEL, 36, SPECIES_TOXAPEX}},
    [SPECIES_MUDBRAY]               = {{EVO_LEVEL, 30, SPECIES_MUDSDALE}},
    [SPECIES_DEWPIDER]              = {{EVO_LEVEL, 20, SPECIES_ARAQUANID}},
    [SPECIES_FOMANTIS]              = {{EVO_LEVEL, 32, SPECIES_LURANTIS}},
    [SPECIES_MORELULL]              = {{EVO_LEVEL, 27, SPECIES_SHIINOTIC}},
    ...
    [SPECIES_STEENEE]               = {{EVO_MOVE, MOVE_TROP_KICK, SPECIES_TSAREENA}},
    [SPECIES_WIMPOD]                = {{EVO_LEVEL, 30, SPECIES_GOLISOPOD}},
    [SPECIES_SANDYGAST]             = {{EVO_LEVEL, 34, SPECIES_PALOSSAND}},
    [SPECIES_TYPE_NULL]             = {{EVO_LEVEL, 44, SPECIES_SILVALLY}},
    [SPECIES_JANGMO_O]              = {{EVO_LEVEL, 35, SPECIES_HAKAMO_O}},
    [SPECIES_HAKAMO_O]              = {{EVO_LEVEL, 47, SPECIES_KOMMO_O}},
	...
	[SPECIES_NECROZMA]              = {{EVO_MEGA_EVOLUTION, ITEM_ULTRANECROZIUM_Z, SPECIES_NECROZMA_ULTRA}},							
    ...
    [SPECIES_CARKOL]                = {{EVO_LEVEL, 35, SPECIES_COALOSSAL}},
    ...
    [SPECIES_HATTREM]               = {{EVO_LEVEL, 35, SPECIES_HATTERENE}},
    [SPECIES_IMPIDIMP]              = {{EVO_LEVEL, 16, SPECIES_MORGREM}},
    [SPECIES_MORGREM]               = {{EVO_LEVEL, 35, SPECIES_GRIMMSNARL}},
    [SPECIES_MILCERY]               = {{EVO_LEVEL, 34, SPECIES_ALCREMIE}},
    ...
    [SPECIES_DIGLETT_ALOLAN]        = {{EVO_LEVEL, 22, SPECIES_DUGTRIO_ALOLAN}},
    ...
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_SLOWBRO_GALARIAN},
                                       {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING_GALARIAN}},
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_LEVEL, 32, SPECIES_SIRFETCHD}},
